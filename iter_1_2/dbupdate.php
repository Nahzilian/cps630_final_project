...
<table>
        ...
        <?php foreach ($allResult as $result) : ?>
            <tr>
                <?php if ($table == 'car') : ?>
                    <td><a href=<?php echo "/dbudetails.php?table=".$table."&id=".$result['CAR_ID']?>>Update</a></td>
                    <td><?= $result['CAR_ID'] ?></td>
                    <td><?= $result['CAR_MODEL'] ?></td>
                    <td><?= $result['CAR_CODE'] ?></td>
                    <td><?= $result['AVAILABILITY_CODE'] ?></td>
                <?php elseif ($table == 'customer') : ?>
                    <td><a href=<?php echo "/dbudetails.php?table=".$table."&id=".$result['CUSTOMER_ID']?>>Update</a></td>
                ...
                <?php elseif ($table == 'customer_order') : ?>
                    <td><a href=<?php echo "/dbudetails.php?table=".$table."&id=".$result['ORDER_ID']?>>Update</a></td>
                ...
                <?php elseif ($table == 'driver_review') : ?>
                    <td><a href=<?php echo "/dbudetails.php?table=".$table."&id=".$result['REVIEW_ID']?>>Update</a></td>
                    <td><?= $result['REVIEW_ID'] ?></td>
                    <td><?= $result['REVIEW_CONTEXT'] ?></td>
                    <td><?= $result['REVIEW_SCORE'] ?></td>
                    <td><?= $result['CAR_ID'] ?></td>
                <?php elseif ($table == 'flower') : ?>
                    <td><a href=<?php echo "/dbudetails.php?table=".$table."&id=".$result['FLOWER_ID']?>>Update</a></td>
                    <td><?= $result['FLOWER_ID'] ?></td>
                ...
                <?php elseif ($table == 'product_review') : ?>
                    ...
                    <td><?= $result['FLOWER_ID'] ?></td>
                <?php elseif ($table == 'trip') : ?>
                    <td><a href=<?php echo "/dbudetails.php?table=".$table."&id=".$result['TRIP_ID']?>>Update</a></td>
                    <td><?= $result['TRIP_ID'] ?></td>
